...
export default function PaymentStubModal({ selectedDoc, groupDocs, setActiveModal }) {
  ...
  return createPortal(
    <div className="fixed inset-0 z-[100] flex items-start sm:items-center justify-center p-4 overflow-y-auto">
      <div className="absolute inset-0 bg-gray-900/60 backdrop-blur-md print-hide" onClick={() => setActiveModal(null)}></div>

      <div className="bg-white rounded-3xl shadow-2xl w-full max-w-md max-h-[calc(100dvh-2rem)] overflow-y-auto z-10 border border-gray-100 relative print-slip">
        <button
          className="absolute top-4 right-4 w-8 h-8 rounded-full flex items-center justify-center text-gray-400 hover:bg-gray-100 print-hide"
        ...
        <div className="p-6 sm:p-8">
          ...
          <div className="flex flex-col items-center py-6 border-b border-dashed border-gray-300">
            ...
            <p className="font-mono text-base font-black text-gray-900 tracking-wider mt-3">{tracking}</p>
          ...
          <div className="flex flex-col sm:flex-row gap-3 mt-6 print-hide">
            <button
              onClick={() => setActiveModal(null)}
